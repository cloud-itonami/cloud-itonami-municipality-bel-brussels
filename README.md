# cloud-itonami-municipality-bel-brussels
...
entirely, even at the bare domain root — abandoned without forcing it.
Both entries here instead cite the City of Brussels' own
[bruxelles.be/reglements-communaux](https://www.bruxelles.be/reglements-communaux)
page, which rendered fully: the **Règlement d'ordre intérieur du
Conseil communal** (Municipal Council Rules of Procedure, adopted
2018-01-22, posted 2018-05-17) and the **Code déontologique** (Code of
Ethics, adopted 2013-10-21, posted 2014-01-25).
...
festivals and heritage sites for Brussels:
...
itself remains the City of Brussels's; this repo stores only citation
